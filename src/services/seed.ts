    ...
    timeline: [
      {
        ...
        campaignId: C,
        sessionId: "session-1",
        title: "The gate that opened inward",
        body: "The party breached the East Gate of the Kaer of Ruin and found the ward-lock had been sealed from the inside. First camp was made in the cistern halls.",
        characterIds: [ch.korgath, ch.zephyrine, ch.thrakka],
        visibility: "all",
        occurredAt: now - 13 * DAY,
      ...
      },
      {
        ...
        campaignId: C,
        sessionId: "session-1",
        title: "A spirit begs for the dark",
        body: "Zephyrine spoke with a bound spirit in the cistern that pleaded to be 'let out into the dark'. It spoke of a presence that loves the kaer's dead.",
        characterIds: [ch.zephyrine],
        visibility: "all",
        occurredAt: now - 13 * DAY + 3600_000,
        createdAt: now - 13 * DAY,
      },
      {
        id: "tl-3",
        campaignId: C,
        sessionId: "session-1",
        title: "Corruption in the water",
        body: "Traces of Horror-corruption were found in the kaer's water supply. Korgath felt a resonance in his Liferock.",
        characterIds: [ch.korgath],
        visibility: "all",
        occurredAt: now - 13 * DAY + 7200_000,
        createdAt: now - 13 * DAY,
      },
      {
        id: "tl-4",
        campaignId: C,
        title: "The Blight-Walker watches",
        body: "GM lore: the lesser Horror ruling the kaer has noticed the party and intends to welcome them as new 'congregation' rather than kill them outright.",
        characterIds: [ch.blight],
        visibility: "gm",
    ...
    knowledge: [
      {
        id: "kn-1",
        campaignId: C,
        title: "Earthdawn 4e — Spellcasting",
        kind: "rulebook",
        gmOnly: false,
        excerpt:
          "To weave a spell, a magician attunes threads to the matrix holding it, then makes a Spellcasting test against the target's Spell Defense. Raw casting is possible but risks damage from astral corruption.",
      },
      {
        id: "kn-2",
        campaignId: C,
        title: "Earthdawn 4e — Karma & Recovery",
        kind: "rulebook",
        gmOnly: false,
        excerpt:
          "Adepts spend Karma to add a Karma die to eligible tests. Karma refreshes during a night's rest. Recovery tests restore damage a limited number of times per day, set by Toughness.",
      },
      {
        id: "kn-3",
        campaignId: C,
        title: "Earthdawn 4e — Casting While Injured",
        kind: "rulebook",
        gmOnly: false,
        excerpt:
          "A wounded magician (damage at or above the Wound Threshold) takes a -1 penalty per wound to all tests, including Spellcasting. Knockdown and harried conditions impose further penalties.",
      },
      {
        id: "kn-4",
        campaignId: C,
        title: "Campaign Lore — The Blight-Walker's true name",
        kind: "lore",
        gmOnly: true,
        excerpt:
          "The Horror's true name is 'Soft-Hands-That-Hold'. Speaking it within the kaer weakens its hold over the congregation for one scene.",
      },
    ],
    evals: [
      {
      ...
      },
      {
        id: "ev-2",
        campaignId: C,
        question: "What's the penalty for casting while injured?",
        faithfulness: 88,
        relevance: 90,
        accuracy: 86,
        createdAt: now - 3 * DAY,
      },
      {
        id: "ev-3",
        campaignId: C,
        question: "How does Karma refresh?",
        faithfulness: 93,
        relevance: 95,
        accuracy: 91,
        createdAt: now - 1 * DAY,
